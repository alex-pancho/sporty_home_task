...
class WebElement():
    ...
    def find(self, timeout=10):
        ...
        try:
            ...
            log.info(('Element not found on the page!', 'red'))
    ...
    def wait_until_not_visible(self, timeout=10):
        ...
        if element:
            ...
            while not visibility and iteration < 10:
                ...
                visibility = self._web_driver.execute_script(js, element)
                log.info('Element %s visibility: %s', self._locator, visibility)
    ...
    def get_text(self):
        ...
        except (EXCEPT.WebDriverException, EXCEPT.JavascriptException) as e:
...
class ManyWebElements(WebElement):
    ...
    def find(self, timeout=10):
        ...
        try:
            ...
            log.info(('Elements not found on the page!', 'red'))
